...
namespace Eco.ET.TechTree
{
    ...
    [Serialized]
    [LocDisplayName("Electric Skid Steer")]
    [Weight(25000)]
    [RequireComponent(typeof(VehicleToolComponent))]
    [Tag("Excavation")]
    [Ecopedia("Crafted Objects", "Vehicles", createAsSubPage: true)]
    public partial class ElectricSkidSteerItem : WorldObjectItem<ElectricSkidSteerObject>, IPersistentData
    {
    ...
    {
        public ElectricSkidSteerRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "ElectricSkidSteer",  //noloc
                displayName: Localizer.DoStr("Electric Skid Steer"),
                ...
                ingredients: new List<IngredientElement>
                {
                    ...
                    new IngredientElement(typeof(ElectricUpgradeKitItem), 4, true),
                },
                ...
                {
                    new CraftingElement<ElectricSkidSteerItem>()
                });
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(ElectricSkidSteerRecipe), start: 40, skillType: typeof(IndustrySkill));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Skid Steer"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Electric Skid Steer"), recipeType: typeof(ElectricSkidSteerRecipe));
    ...
    [Ecopedia("Crafted Objects", "Vehicles", subPageName: "ElectricSkidSteer Item")]
    public partial class ElectricSkidSteerObject : PhysicsWorldObject, IRepresentsItem
    {
        static ElectricSkidSteerObject()
        {
            WorldObject.AddOccupancy<ElectricSkidSteerObject>(new List<BlockOccupancy>(0));
        }
        public override TableTextureMode TableTexture => TableTextureMode.Metal;
        public override bool PlacesBlocks => false;
        public override LocString DisplayName { get { return Localizer.DoStr("Electric Skid Steer"); } }
        public Type RepresentedItemType { get { return typeof(ElectricSkidSteerItem); } }
        private ElectricSkidSteerObject() { }
        protected override void Initialize()
        {
            base.Initialize();
            this.GetComponent<CustomTextComponent>().Initialize(200);
            this.GetComponent<BatterySupplyComponent>().Initialize(1);
            this.GetComponent<BatteryConsumptionComponent>().Initialize(this.GetComponent<BatterySupplyComponent>(), 45);
